...
<p align="center">
  ...
  <br>
  <i> Quá trình huấn luyện thử nghiệm mô hình <mark><b>APNet-EML</b></mark> trên tập dữ liệuCIFAR10, kích thước ảnh 64x64 (Frozen=False)</i> 
</p>
...
<p>
  <mark><b>Kết quả huấn luyện trên tập Bảo tàng quân khu 9 - Cần Thơ</b></mark> so sánh các chiến lược huấn luyện để đánh giá mức độ ảnh hưởng giữa các thành phần được đề xuất và so sánh với các baseline models (Frozen=False)
</p>

<p align="center">
  <img src="images/DoChinhXac.jpg" width="900">
  <br>
  <i>  Độ chính xác giữa các mô hình Baseline so sánh APNet cùng với các chiến lược huấn luyện khác nhau trên tập <mark><b> dữ liệu bảo tàng quân khu 9</b></mark> (Frozen=True)</i>
</p>
